{{-- CHECKOUT FORM: transactions/checkout-form.blade.php --}}
@extends('layouts.app')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-xl p-8">
        <div class="flex items-center space-x-3 mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Checkout Barang</h1>
                <p class="text-gray-600">Serahkan barang kepada peminjam</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-blue-50 rounded-lg p-4">
                <p class="text-sm text-blue-700 font-semibold mb-2">PEMINJAM</p>
        ...
        <form action="{{ route('transactions.processCheckout', $transactionId) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="space-y-3">
                    <label
                        ...
                        <input type="radio" name="condition" value="good" class="w-5 h-5 text-purple-600" required>
                        <div class="ml-3">
                            <p class="font-medium text-gray-800">Good Condition</p>
                            <p class="text-sm text-gray-600">Barang dalam kondisi baik tanpa kerusakan</p>
                        </div>
                    </label>

                    <label
                        class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                        <input type="radio" name="condition" value="minor_damage" class="w-5 h-5 text-purple-600">
                        <div class="ml-3">
                            <p class="font-medium text-gray-800">Minor Damage</p>
                            <p class="text-sm text-gray-600">Ada kerusakan kecil yang tidak mengganggu fungsi</p>
                        </div>
                    </label>
                </div>
                @error('condition')
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                <p class="text-sm text-blue-800">
                    ...
                    Pastikan kondisi barang sudah dicek dengan teliti sebelum diserahkan kepada peminjam.
                </p>
            </div>
