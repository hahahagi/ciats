...
<head>
    ...
    <title>Management Login - CIATS</title>
    ...
    .gradient-bg {
        background: #1e293b; /* Darker slate for Admin */
    }
    ...
    .input-focus:focus {
        border-color: #f59e0b; /* Amber/Orange for Admin focus */
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8 float-animation">
            <div class="inline-block bg-white p-4 rounded-2xl shadow-2xl mb-4">
                <i class="fas fa-user-shield text-slate-800 text-5xl"></i>
            </div>
            <h1 class="text-4xl font-bold text-white mb-2">CIATS</h1>
            <p class="text-gray-300">Management Access</p>
        </div>
            ...
            <form action="/login" method="POST">
                ...
                <div class="mb-5">
                    <label class="block text-gray-700 font-medium mb-2">
                        <i class="fas fa-envelope text-slate-800 mr-2"></i>
                        Email
                    </label>
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 font-medium mb-2">
                        <i class="fas fa-lock text-slate-800 mr-2"></i>
                        Password
                    </label>
                    <div class="relative">
